...
cbigStep (DoWhile c b, s)
 |bbigStep (b, snd(cbigStep (c, s))) = cbigStep (DoWhile c b, snd(cbigStep (c, s)))
 |otherwise = cbigStep (Skip, snd(cbigStep (c, s)))
--cbigStep (Repeat c b,s) = cbigStep (Seq c (While (Not b) c), s)
cbigStep (Repeat c b, s)
 |bbigStep ((Not b), snd(cbigStep (c, s))) = cbigStep (Repeat c b, snd(cbigStep (c, s)))
 |otherwise = cbigStep (Skip, snd(cbigStep (c, s)))
...
-- Exemplo usando iF:
-- Se o conteúdo da variável x for positivo coloca "1" na variavel y, caso contrário coloca 0

exemplo1 :: C
exemplo1 = (If (Leq (Var "x") (Num 0)) (Atrib (Var "y") (Num 0)) (Atrib (Var "y") (Num 1)))

-- Exemplo usando do While:
-- Coloca -10 no y e 10 no z

exemplo2 :: C
exemplo2 = (Seq (Seq (Atrib (Var "z") (Num 0)) (Atrib (Var "y") (Num 0))) (DoWhile (Seq (Atrib (Var "z") (Soma (Var "z") (Num 1))) (Atrib (Var "y") (Sub (Var "y") (Num 1)))) (Not (Igual (Var "z") (Num 10)))))
